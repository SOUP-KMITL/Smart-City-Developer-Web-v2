angular
	...
	.controller('marketplaceCityServiceController',function($uibModal,$anchorScroll,$location,$scope,$http,DevelopersFactory,AuthenticationService){
		...
		DevelopersFactory.getPageService(0,10)
		.then(function(data){
			$scope.services = data.data.content;
			console.log(data);
		  	$scope.maxSize = 5;
