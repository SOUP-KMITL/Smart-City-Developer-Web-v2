angular
	...
	.controller('createCityServiceController',function($routeParams,$uibModal,$anchorScroll, uploadService,$location,$scope,$http,DevelopersFactory,AuthenticationService){
